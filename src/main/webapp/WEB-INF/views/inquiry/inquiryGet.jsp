			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<c:if test="${user eq '[ROLE_ADMIN]' }">
						<button data-oper='inqReply' class="btn btn-default">답변</button>
					</c:if>

					<sec:authentication property="principal" var="pinfo" />

					<c:if test="${pinfo.username eq inquiry.iwriter }">
						<button data-oper='modify' class="btn btn-warning">수정 및 삭제</button>
					</c:if>
					<c:if test="${user eq '[ROLE_ADMIN]' and pinfo.username ne inquiry.iwriter}">
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("button[data-oper='modify']").on("click", function(e) {
			operForm.attr("action", "/inquiry/inquiryModify").submit();
		});
		...
		$("button[data-oper='inqReply']").on("click", function(e) {
			operForm.attr("action", "/inquiry/inquiryReply").submit();
		});
		$("button[data-oper='remove']").on("click", function(e) {
			operForm.attr("action", "/inquiry/inquiryRemove").attr("method", "post").submit();
		});
	});
</script>
