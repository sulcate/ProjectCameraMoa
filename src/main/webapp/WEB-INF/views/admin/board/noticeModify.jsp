...
<%@ include file="../includes/header.jsp" %>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
            	<div>
           		...
           		<div>
		<form role="form" action="/admin/board/noticeModify" method="post">
		
		<input type="hidden" name="n" value="${notice.nbno }"/>

			<div class="form-group">
				<label>작성 날짜</label><br>
				<input class="form-control" name='regDate' value="<fmt:formatDate pattern = "yyyy/MM/dd" value = "${notice.nregdate}" />" readonly>
			</div>
			
			<div class="form-group">
				<label>최종 수정 날짜</label><br>
				<input class="form-control" name='updateDate' value="<fmt:formatDate pattern = "yyyy/MM/dd" value = "${notice.nupdateDate}" />" readonly>
			</div>
			
			<div class="form-group">
				<label>작성자</label><br>
				<input class="form-control" name='nwriter' value="${notice.nwriter }" readonly>
			</div>

			<div class="form-group">
				<label>글번호</label><br>
				<input class="form-control" name='nbno' value="${notice.nbno }" readonly>
			</div>

			<div class="form-group">
				<label>제목</label><br>
				<input class="form-control" name='ntitle' value="${notice.ntitle }">
			</div>

			<div class="form-group">
				<label>내용</label><br>
				<textarea class="form-control" rows="6" cols="50" name='ncontent'>${notice.ncontent }</textarea>
	...
	<script>
 		$("#back_Btn").click(function(){
  		//history.back();
  		location.href = "/admin/board/noticeGet?n=" + ${notice.nbno };
 		});   
	</script>
