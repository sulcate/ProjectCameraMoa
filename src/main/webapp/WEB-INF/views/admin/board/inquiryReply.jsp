...
<%@ include file="../includes/header.jsp" %>
	...
	<div>
					...
					<div class="form-group">
						<label>제목</label> <input class="form-control" name='ititle'
							value="${inquiry.ititle }" readonly="readonly">
					</div>

					<div class="form-group">
						<label>내용</label>
						<textarea class="form-control" rows="10" name='icontent'
							readonly="readonly">${inquiry.icontent }</textarea>
					</div>

					<div class="form-group">
						<label>작성자</label> <input class="form-control" name='iwriter'
							value="${inquiry.iwriter }" readonly="readonly">
					</div>
	...
	<div>
		<form role="form" action="/admin/board/inquiryReply" method="post">
		
			<div class="form-group">
				<input type="hidden" class="form-control" name="ref" value="${inquiry.ibno }"/>
			</div>
			
			<div class="form-group">
				<label>답변 작성자</label><br> <input class="form-control" name='iwriter' value='<sec:authentication property="principal.username"/>' readonly>
			</div>
		
			<div class="form-group">
				<input type="hidden" class="form-control" name='ititle' required="required" value="└ 답변 드립니다">
			</div>

			<div class="form-group">
				<label>답변 내용</label><br> <textarea class="form-control" rows="10" name='icontent' required="required" ></textarea>
			</div>
