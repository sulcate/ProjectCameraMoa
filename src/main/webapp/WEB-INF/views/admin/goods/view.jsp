	...
	<div>
		...
		<input type="hidden" name="n" value="${goods.gdsNum }"/>
			...
			<div class="form-group">
				<label>상품분류</label><br>
				<input class="form-control" value="${goods.cateCode }" readonly>
			</div>

			<div class="form-group">
				<label>상품명</label><br>
				<input class="form-control" value="${goods.gdsName }" readonly>
			</div>

			<div class="form-group">
				<label>브랜드</label><br>
				<input class="form-control" value="${goods.gdsBrand }" readonly>
			</div>

			<div class="form-group">
				<label>판매가격</label><br>
				<input class="form-control" value="<fmt:formatNumber value="${goods.gdsPrice }" pattern="###,###,###"/>" readonly>
			</div>

			<div class="form-group">
				<label>상품수량</label><br>
				<input class="form-control" value="${goods.gdsStock }" readonly>
			</div>

			<div class="form-group">
				<label>상세 설명</label><br>
				<%-- <span>${goods.gdsDes }</span> --%>
				<textarea class="form-control" rows="6" cols="50" name='gdsDes' readonly>${goods.gdsDes }</textarea>
			</div>
